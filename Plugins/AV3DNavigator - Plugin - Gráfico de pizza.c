...
int main (int argc, char * argv[])
	...
	for (i = 0; i < argi; i++)
		...
		for (j = 0; j < resolucao; j++)
			...
			printf("%Lf,0,0;%Lf,%Lf,%Lf;%Lf,%Lf,%Lfc%s|", x, x, raio * cosl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), x, raio * cosl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), rgb[i]);
	...
	for (i = 0; i < argi; i++)
		...
		for (j = 0; j < resolucao; j++)
			printf("0,%Lf,%Lf;%Lf,%Lf,%Lf;%Lf,%Lf,%Lf;0,%Lf,%Lfc%s|", raio * cosl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), espessura, raio * cosl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + j * 2 * M_PI * valoresnumericos[i] / soma / resolucao), espessura, raio * cosl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * cosl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), raio * sinl(anguloinicial + (j + 1) * 2 * M_PI * valoresnumericos[i] / soma / resolucao), rgb[i]);
