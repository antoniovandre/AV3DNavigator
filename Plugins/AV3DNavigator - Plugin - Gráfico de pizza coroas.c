...
Arquivo gerador de um espaço do AV3DNavigator gráfico de pizza coroas tridimensional.
...
int main (int argc, char * argv[])
	...
	for (i = 0; i < argi; i++)
		{R = sqrtl(valoresnumericos[i] / M_PI + r * r); r = R;}
	...
	for (i = 0; i < argi; i++)
		{
		R = sqrtl(valoresnumericos[i] / M_PI + r * r);
