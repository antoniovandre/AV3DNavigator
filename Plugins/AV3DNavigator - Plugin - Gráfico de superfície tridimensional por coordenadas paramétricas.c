...
#define CALLEVALSOFTWARE {char * ptreval = antoniovandre_eval(valorstr, precisao); printf("%s", ptreval); free (ptreval); valorstr = malloc(MAXTAMANHOCAMPO);}
...
int main (int argc, char * argv[])
	...
	char * valorstr = malloc(MAXTAMANHOCAMPO);
