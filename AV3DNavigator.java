...
public class AV3DNavigator extends JComponent
	...
	public static int TamanhoJanelaHelpY = 560;
			...
			public void keyPressed(KeyEvent ke)
				...
				if (ContadorFrames == FramesDeslocamento)
					...
					switch (keyCode)
						...
						case KeyEvent.VK_H:
							if (ke.isShiftDown()) {Rot = 0; Rott = Rot; ContadorFrames = FramesDeslocamento;} else {FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; CameraId = -1; if (! (Math.abs(Rot + DeslocamentoAngular) >= AntonioVandre.MaximoValorReal)) {Rot += DeslocamentoAngular; ContadorFrames = 0;} else VariavelLimiteAtingido();}
						...
						case KeyEvent.VK_K:
							if (ke.isControlDown())
								{RaioRot = 0; FlagCoordRot = 0; FlagCoordRotOnce = 0;}
						...
						case KeyEvent.VK_UP:
							...
							if (ke.isShiftDown())
								{
								if ((Math.abs(x + Math.cos(Teta) >= 0 && Math.abs(Math.sin(Teta)) >= 1 - TricksFactor * DeslocamentoLinear && Math.abs(Math.cos(Rot)) >= 1 - TricksFactor * DeslocamentoLinear / 10 ? 0 : Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.cos(Teta) >= 0 ? (Math.sin(Phi) >= 0 ? 1 : -1) : (Math.sin(Phi) >= 0 ? -1 : 1)) * (Math.cos(Teta) >= 0 ? (Math.cos(Rot) >= 0 ? -1 : 1) : (Math.sin(Rot) >= 0 ? -1 : 1)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - Math.cos(Teta) >= 0 && Math.abs(Math.sin(Teta)) >= 1 - TricksFactor * DeslocamentoLinear && Math.abs(Math.cos(Rot)) >= 1 - TricksFactor * DeslocamentoLinear / 10 ? DeslocamentoLinear * (Math.sin(Teta) * Math.sin(Phi) >= 0 ? -1 : 1) : Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.sin((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && (! (Math.cos(Rot) >= 0 && Math.sin(Rot) < 0)) ? -1 : 1)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - Math.sin((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * (Math.cos(Phi) >= 0 ? 1 : (Math.sin(Phi) * Math.cos(Phi) >= 0 ? -1 : 1))) >= AntonioVandre.MaximoValorReal))
									VariavelLimiteAtingido();
								else
									{
									x += Math.cos(Teta) >= 0 && Math.abs(Math.sin(Teta)) >= 1 - TricksFactor * DeslocamentoLinear && Math.abs(Math.cos(Rot)) >= 1 - TricksFactor * DeslocamentoLinear / 10 ? 0 : Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.cos(Teta) >= 0 ? (Math.sin(Phi) >= 0 ? 1 : -1) : (Math.sin(Phi) >= 0 ? -1 : 1)) * (Math.cos(Teta) >= 0 ? (Math.cos(Rot) >= 0 ? -1 : 1) : (Math.sin(Rot) >= 0 ? -1 : 1)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1);
									y -= Math.cos(Teta) >= 0 && Math.abs(Math.sin(Teta)) >= 1 - TricksFactor * DeslocamentoLinear && Math.abs(Math.cos(Rot)) >= 1 - TricksFactor * DeslocamentoLinear / 10 ? DeslocamentoLinear * (Math.sin(Teta) * Math.sin(Phi) >= 0 ? -1 : 1) : Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.sin((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && (! (Math.cos(Rot) >= 0 && Math.sin(Rot) < 0)) ? -1 : 1);
									z -= Math.sin((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * (Math.cos(Phi) >= 0 ? 1 : (Math.sin(Phi) * Math.cos(Phi) >= 0 ? -1 : 1));
									}
								}
							else
								{
						...
						case KeyEvent.VK_LEFT:
							...
							if ((Math.abs(x + Math.cos(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.cos(Rot)) * (Math.cos(Rot) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - Math.cos(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * Math.sin((Teta + Math.PI / 2) * Math.cos(Rot)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) >= 0 ? -1 : 1)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - Math.sin(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * (Math.cos(Phi) >= 0 ? 1 : (Math.sin(Phi) >= 0 ? 1 : -1))) >= AntonioVandre.MaximoValorReal))
								VariavelLimiteAtingido();
							else
								{
								x += Math.cos(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.cos(Rot)) * (Math.cos(Rot) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.cos(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1);
								y -= Math.cos(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * Math.sin((Teta + Math.PI / 2) * Math.cos(Rot)) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) < 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) >= 1 - TricksFactor * DeslocamentoLinear && Math.sin(Phi) < -1 + TricksFactor * DeslocamentoLinear && Math.cos(Rot) * Math.sin(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) >= 0 ? -1 : 1) * (Math.cos(Teta) >= 0 ? 1 : -1) * (Math.sin(Teta) < -1 + TricksFactor * DeslocamentoLinear && Math.sin(Phi) >= 1 - TricksFactor * DeslocamentoLinear && Math.cos(Rot) >= 0 ? -1 : 1);
								z -= Math.sin(-(Phi + Math.PI / 2) * Math.sin(Rot) * Math.cos(Phi)) * (Math.cos(Phi) >= 0 ? 1 : (Math.sin(Phi) >= 0 ? 1 : -1));
								}
