				...
				if (ContadorFrames == FramesDeslocamento)
					...
					switch (keyCode)
						...
						case KeyEvent.VK_UP:
							...
							if (ke.isShiftDown())
								{
								if ((Math.abs(x + Math.abs(Math.cos(Teta)) >= 1 / Math.sqrt(2) ? (Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.sin(Phi) >= 0 ? -1 : 1) * (Math.cos(Rot) >= 0 ? 1 : -1)) : (Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.sin(Phi) >= 0 ? -1 : 1) * (Math.sin(Rot) >= 0 ? 1 : -1))) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.sin((Teta + Math.PI / 2) * Math.sin(Rot))) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - Math.sin((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * (Math.cos(Phi) >= 0 ? 1 : (Math.sin(Phi) >= 0 ? 1 : -1))) >= AntonioVandre.MaximoValorReal))
									VariavelLimiteAtingido();
								else
									{
									x += Math.abs(Math.cos(Teta)) >= 1 / Math.sqrt(2) ? (Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.sin(Phi) >= 0 ? -1 : 1) * (Math.cos(Rot) >= 0 ? 1 : -1)) : (Math.cos((Phi + Math.PI / 2) * Math.cos(Rot) * Math.cos(Phi)) * Math.cos((Teta + Math.PI / 2) * Math.sin(Rot)) * (Math.sin(Phi) >= 0 ? -1 : 1) * (Math.sin(Rot) >= 0 ? 1 : -1));
