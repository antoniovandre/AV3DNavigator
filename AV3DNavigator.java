 ...
 * 
 * Última atualização: 16-10-2025. Não considerando alterações em variáveis globais.
 */
...
public class AV3DNavigator extends JComponent
	...
	public int CorValorR = 0; // Default: 0.
	...
	public static int TamanhoEspacoLabelStatus = 370; // Default: 370.
	public static int TamanhoEspacoLabelURL = 65; // Default: 65.
	public static int TamanhoJanelaHelpX = 1800;
	public static int TamanhoJanelaHelpY = 720;
	...
	public static int TamanhoLendoEspacoX = 120; // Default: 120.
	public static int TamanhoLendoEspacoY = 40; // Default: 40.
	...
	public double VelocidadeRotacaoAutomatica = 1; // Default: 1.
	...
	public int TotalRenderingInit = 400; // Default: 400.
	public int RenderingCircleSteps = 16; // Default: 16.
	public int RadiusRenderingCircle = 10; // Default: 10.
	public int Remainder2PI = 1; // Default: 1.
	public double MouseSensi = 1; // Default: 1.
	public int NoMouse = 0; // Default: 0.
	...
	public double RaioRotHor = 0;
	public double RaioRotVert = 0;
	public int FlagRotTetaPos = 0;
	public int FlagRotTetaNeg = 0;
	public int FlagRotPhiPos = 0;
	public int FlagRotPhiNeg = 0;
	public int FlagRotCircPos = 0;
	public int FlagRotCircNeg = 0;
	public int FlagRotRotTetaPos = 0;
	public int FlagRotRotTetaNeg = 0;
	public int FlagRotRotPhiPos = 0;
	public int FlagRotRotPhiNeg = 0;
	...
	public int FlagCoordRotCirc = 0;
	public int FlagCoordRotRotHor = 0;
	public int FlagCoordRotRotVert = 0;
	...
	public double RotacaoRotHor = 0;
	public double RotacaoRotVert = 0;
	public double RotacaoBak = Rotacao;
	public double RotacaoRotHorBak = RotacaoRotHor;
	public double RotacaoRotVertBak = RotacaoRotVert;
	public double Teta0Rotacao;
	public double Phi0Rotacao;
	public double Rot0Rotacao;
	public double Teta0RotacaoCirc;
	public double Phi0RotacaoCirc;
	public double Rot0RotacaoCirc;
	public double TetaRotHor;
	public double PhiRotHor;
	public double RotRotHor;
	public double TetaRotVert;
	public double PhiRotVert;
	public double RotRotVert;
	public double x0RotacaoCirc;
	public double y0RotacaoCirc;
	public double z0RotacaoCirc;
	public double xRotacaoRotHor;
	public double yRotacaoRotHor;
	public double zRotacaoRotHor;
	public double xRotacaoRotVert;
	public double yRotacaoRotVert;
	public double zRotacaoRotVert;
	...
	private static class TrianguloRenderingType extends Object
		{
		int x1; 
		int y1;
		int x2;
		...
		public TrianguloRenderingType(int x1, int y1, int x2, int y2, int x3, int y3)
			{
			this.x1 = x1;
			this.y1 = y1;
			this.x2 = x2;
	...
	public LinkedList<TrianguloRenderingType> TriangulosRenderingShape = new LinkedList<TrianguloRenderingType>();
	...
	public void addTriangulosRenderingShape(int x1, int y1, int x2, int y2, int x3, int y3)
		{
		TriangulosRenderingShape.add(new TrianguloRenderingType(x1, y1, x2, y2, x3, y3));
	...
	public void paintComponent(Graphics g)
		...
		try
			{
			if (TriangulosRenderingShape.size() == 0)
				{
				...
				*/
				...
				{
				Tpaint = TriangulosRenderingShape.size();

				g.setColor(new Color(CorJanelaR, CorJanelaG, CorJanelaB));

				for (i = 0; i < Tpaint; i++)
					{
					TrianguloRenderingType Triangulo = TriangulosRenderingShape.get(i);
					...
					if (INIarr[i].replaceAll(" ", "").charAt(0) != '#')
						...
						if (INIelements.length == 2)
							switch (INIelements[0].replaceAll(" ", ""))
								...
								case "VelocidadeRotacaoAutomatica":
									if (AntonioVandre.NumeroRealPositivo(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate())))
										{
										double Temp = Double.parseDouble(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate()));

										if ((Temp > 0.1) && (Temp < 2))
											{
											VelocidadeRotacaoAutomatica = Temp;
											}
										}
								...
								case "Stretch":
									if ((new Expression(INIelements[1].replaceAll(" ", ""))).calculate() == (int) (new Expression(INIelements[1].replaceAll(" ", ""))).calculate())
										{
										ValorInteiro = (int) (new Expression(INIelements[1].replaceAll(" ", ""))).calculate();
								...
								case "ResolucaoTriangulos":
									if (AntonioVandre.NumeroNaturalPositivo(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate())))
										{
										int Temp = Integer.parseInt(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate()));
								...
								case "PrecisaoApfloat":
									if (AntonioVandre.NumeroNaturalPositivo(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate())))
										{
										PrecisaoApfloat = Integer.parseInt(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate()));
										}
								...
								case "TotalRenderingInit":
									if (AntonioVandre.NumeroNatural(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate())))
										{
										int Temp = Integer.parseInt(String.valueOf(new Expression(INIelements[1].replaceAll(" ", "")).calculate()));

										if (Math.abs(Temp) <= AntonioVandre.MaximoValorInteiro)
											{
											TotalRenderingInit = Temp;
											}
										}
	...
	public void RotTetaPos ()
		{
		FlagCoordRot = 0; FlagCoordRotHor = 1; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;

		if (! (Math.abs(RotacaoTeta + DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) RotacaoTeta += DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

		if (Math.abs(Teta) < TetaMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if (! (Math.abs(Teta + DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) {Teta += DeslocamentoAngular * VelocidadeRotacaoAutomatica; x = xRotacaoTeta + RaioTeta * Math.cos(RotacaoTeta) * Math.cos(Phi); y = yRotacaoTeta - RaioTeta * Math.sin(RotacaoTeta) * Math.cos(Phi); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Teta -= Math.signum(Teta) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Tetat = Teta; FlagTetaInferior = 1;}
		}

	public void RotTetaNeg ()
		{
		FlagCoordRot = 0; FlagCoordRotHor = 1; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;
	...
	public void RotPhiPos ()
		{
		FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 1; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;

		if (! (Math.abs(RotacaoPhi - DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) RotacaoPhi -= DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

		if (Math.abs(Phi) < PhiMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if (! (Math.abs(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) {Phi -= DeslocamentoAngular * VelocidadeRotacaoAutomatica; x = xRotacaoPhi + RaioPhi * Math.cos(RotacaoPhi) * Math.cos(Teta); y = yRotacaoPhi - RaioPhi * Math.cos(RotacaoPhi) * Math.sin(Teta); z = zRotacaoPhi - RaioPhi * Math.sin(RotacaoPhi); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Phi -= Math.signum(Phi) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Phit = Phi; FlagPhiSuperior = 1;}
		}

	public void RotPhiNeg ()
		{
		FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 1; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;
	...
	public void RotRotTetaPos()
		{
		FlagCoordRot = 1; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;

		if (! (Math.abs(Rotacao + DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) Rotacao += DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

		if (Math.abs(Teta) < TetaMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if (Math.abs(Phi) < PhiMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if ((! (Math.abs(Teta + DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.cos(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.cos(Phi))) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Rot + DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal))) {Teta += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot); Phi -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.cos(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.cos(Phi)); Rot += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.sin(Phi); x = xRotacao + RaioRot * Math.cos(Phi + Math.PI) * Math.cos(Teta); y = yRotacao - RaioRot * Math.cos(Phi + Math.PI) * Math.sin(Teta); z = zRotacao - RaioRot * Math.sin(Phi + Math.PI); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Phi -= Math.signum(Phi) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Phit = Phi; FlagPhiInferior = 1;}} else {Teta -= Math.signum(Teta) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Tetat = Teta; FlagTetaInferior = 1;}
		}

	public void RotRotTetaNeg ()
		{
		FlagCoordRot = 1; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;
	...
	public void RotRotPhiPos ()
		{
		FlagCoordRot = 1; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;

		if (! (Math.abs(Rotacao - DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) Rotacao += DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

		if (Math.abs(Teta) < TetaMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if (Math.abs(Phi) < PhiMax - DeslocamentoAngular * VelocidadeRotacaoAutomatica) {if ((! (Math.abs(Teta - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.cos(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.cos(Phi))) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Rot - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal))) {Teta -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot); Phi -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.cos(Phi - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(Rot) * Math.cos(Phi)); Rot -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(Rot) * Math.sin(Phi); x = xRotacao + RaioRot * Math.cos(Phi + Math.PI) * Math.cos(Teta); y = yRotacao - RaioRot * Math.cos(Phi + Math.PI) * Math.sin(Teta); z = zRotacao - RaioRot * Math.sin(Phi + Math.PI); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Phi -= Math.signum(Phi) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Phit = Phi; FlagPhiInferior = 1;}} else {Teta -= Math.signum(Teta) * DeslocamentoAngular * VelocidadeRotacaoAutomatica; ContadorFrames = FramesDeslocamento; Tetat = Teta; FlagTetaInferior = 1;}
		}

	public void RotRotPhiNeg ()
		{
		FlagCoordRot = 1; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;
	...
	public void RotCircPos ()
		{
		FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 1; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1;
	...
	public void mainrun (String ArquivoEspaco, String Debug)
		...
		AtribuicaoString = "Antonio Vandré's AV3DNavigator.|sourceforge.net/u/antoniovandre";
		...
		FrameEspaco.addMouseListener(new MouseListener()
			...
			public void mousePressed(MouseEvent MouseEvento)
				...
				switch(MouseEvento.getButton())
					...
					default:
						if (NoMouse == 0) NoMouse = 1; else NoMouse = 0;
			...
			public void mouseReleased(MouseEvent MouseEvento)
				...
				if ((FlagRotTetaPos == 0) && (FlagRotTetaNeg == 0) && (FlagRotPhiPos == 0) && (FlagRotPhiNeg == 0) && (FlagRotRotTetaPos == 0) && (FlagRotRotTetaNeg == 0) && (FlagRotRotPhiPos == 0) && (FlagRotRotPhiNeg == 0) && (FlagRotCircPos == 0) && (FlagRotCircNeg == 0))
					{
				...
				if (MouseDown == 0)
					...
					if ((MouseX > 0) && (MouseX <= TamanhoPlanoX) && (MouseY > FrameEspaco.getInsets().top) && (MouseY <= TamanhoPlanoY + FrameEspaco.getInsets().top))
						...
						if ((Math.abs(x - FatorMouseWheel * e.getWheelRotation() * Math.cos(Phi) * Math.cos(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y + FatorMouseWheel * e.getWheelRotation() * Math.cos(Phi) * Math.sin(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z + FatorMouseWheel * e.getWheelRotation() * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal))
							...
							{
							x -= FatorMouseWheel * DeslocamentoLinearStatic * e.getWheelRotation() * Math.cos(Phi) * Math.cos(Teta);

							y += FatorMouseWheel * DeslocamentoLinearStatic * e.getWheelRotation() * Math.cos(Phi) * Math.sin(Teta);

							z += FatorMouseWheel * DeslocamentoLinearStatic * e.getWheelRotation() * Math.sin(Phi);
		...
		FrameEspaco.addKeyListener(new KeyListener()
			...
			public void keyPressed(KeyEvent ke)
				...
				switch (keyCode)
					...
					case KeyEvent.VK_H:
						if (ke.isControlDown())
							{FlagRotTetaPos = 0; FlagRotTetaNeg = 0; FlagRotPhiPos = 0; FlagRotPhiNeg = 0; FlagRotRotTetaPos = 0; FlagRotRotTetaNeg = 0; FlagRotRotPhiPos = 0; FlagRotRotPhiNeg = 0;}

						break;

					case KeyEvent.VK_F8:
						if (ke.isShiftDown())
							{if (VelocidadeRotacaoAutomatica > 0.1)VelocidadeRotacaoAutomatica -= 0.1;}
						else
							{if (VelocidadeRotacaoAutomatica < 2)VelocidadeRotacaoAutomatica += 0.1;}

						break;

					case KeyEvent.VK_J:
						if (ke.isControlDown()) {if (ke.isShiftDown()) {FlagRotPhiPos = 1; FlagRotPhiNeg = 0;} else {FlagRotTetaPos = 1; FlagRotTetaNeg = 0;}}

						break;

					case KeyEvent.VK_M:
						if (ke.isControlDown()) {if (ke.isShiftDown()) {FlagRotPhiPos = 0; FlagRotPhiNeg = 1;} else {FlagRotTetaPos = 0; FlagRotTetaNeg = 1;}}

						break;

					case KeyEvent.VK_K:
						if (ke.isControlDown()) {if (ke.isShiftDown()) {FlagRotRotPhiPos = 1; FlagRotRotPhiNeg = 0;} else {FlagRotRotTetaPos = 1; FlagRotRotTetaNeg = 0;}}

						break;

					case KeyEvent.VK_COMMA:
						if (ke.isControlDown()) {if (ke.isShiftDown()) {FlagRotRotPhiPos = 0; FlagRotRotPhiNeg = 1;} else {FlagRotRotTetaPos = 0; FlagRotRotTetaNeg = 1;}}

						break;

					case KeyEvent.VK_F7:
						if (ke.isControlDown()) {if (ke.isShiftDown()) {FlagRotCircPos = 0; FlagRotCircNeg = 1;} else {FlagRotCircPos = 1; FlagRotCircNeg = 0;}}
				...
				if (ContadorFrames == FramesDeslocamento)
					...
					switch (keyCode)
						...
						case KeyEvent.VK_PAGE_UP:
							if (SleepTime < AntonioVandre.MaximoValorInteiro) SleepTime++;
						...
						case KeyEvent.VK_A:
							if (ke.isShiftDown())
								{if (! (Math.abs(xCamera + DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {xCamera += DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
							else
								{FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; if (! (Math.abs(x + DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {x += DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
						...
						case KeyEvent.VK_S:
							if (ke.isShiftDown())
								{if (! (Math.abs(yCamera + DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {yCamera += DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
							else
								{FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; if (! (Math.abs(y - DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {y -= DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
						...
						case KeyEvent.VK_D:
							if (ke.isShiftDown())
								{if (! (Math.abs(zCamera + DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {zCamera += DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
							else
								{FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; if (! (Math.abs(z - DeslocamentoLinearStatic) >= AntonioVandre.MaximoValorReal)) {z -= DeslocamentoLinearStatic; ContadorFrames = 0;} else VariavelLimiteAtingido();}
						...
						case KeyEvent.VK_F:
							FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; RotacaoBak = AntonioVandre.MaximoValorReal;
						...
						case KeyEvent.VK_B:
							...
							if (ke.isShiftDown())
								{
								if (Math.abs(Teta) < TetaMax - DeslocamentoAngular) {if (Math.abs(Phi) < PhiMax - DeslocamentoAngular) {if ((! (Math.abs(Rot - DeslocamentoAngular * Math.sin(Rot) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Teta - DeslocamentoAngular * Math.sin(Rot)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Phi - DeslocamentoAngular * Math.cos(Rot) * Math.cos(Phi - DeslocamentoAngular * Math.cos(Rot) * Math.cos(Phi))) >= AntonioVandre.MaximoValorReal))) {Teta -= DeslocamentoAngular * Math.sin(Rot); Phi -= DeslocamentoAngular * Math.cos(Rot) * Math.cos(Phi - DeslocamentoAngular * Math.cos(Rot) * Math.cos(Phi)); Rot -= DeslocamentoAngular * Math.sin(Rot) * Math.sin(Phi); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Phi -= Math.signum(Phi) * DeslocamentoAngular; ContadorFrames = FramesDeslocamento; Phit = Phi; FlagPhiSuperior = 1;}} else {Teta -= Math.signum(Teta) * DeslocamentoAngular; ContadorFrames = FramesDeslocamento; Tetat = Teta; FlagTetaInferior = 1;}
								}
							else
								{
						...
						case KeyEvent.VK_H:
							if (! (ke.isControlDown())) {if (ke.isShiftDown()) {Rot = 0; Rott = Rot; ContadorFrames = FramesDeslocamento;} else {FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; if (! (Math.abs(Rot + DeslocamentoAngular) >= AntonioVandre.MaximoValorReal)) {Rot += DeslocamentoAngular; ContadorFrames = 0;} else VariavelLimiteAtingido();}}

							break;

						case KeyEvent.VK_N:
							if (ke.isControlDown()) {RaioRot = 0; FlagCoordRot = 0;} else {FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 0; CameraId = -1; if (! (Math.abs(Rot - DeslocamentoAngular) >= AntonioVandre.MaximoValorReal)) {Rot -= DeslocamentoAngular; ContadorFrames = 0;} else VariavelLimiteAtingido();}

							break;

						case KeyEvent.VK_J:
							if (! (ke.isControlDown())) {if (ke.isShiftDown()) RotPhiPos(); else RotTetaPos();}

							break;

						case KeyEvent.VK_M:
							if (! (ke.isControlDown())) {if (ke.isShiftDown()) RotPhiNeg(); else RotTetaNeg();}
						...
						case KeyEvent.VK_K:
							if (! (ke.isControlDown())) {if (ke.isShiftDown()) RotRotPhiPos(); else RotRotTetaPos();}
						...
						case KeyEvent.VK_UP:
							if (ke.isControlDown())
								...
								if (ke.isShiftDown())
									...
									if (Math.abs(Teta) < TetaMax - DeslocamentoAngular) {if (Math.abs(Phi) < PhiMax - DeslocamentoAngular) {if ((! (Math.abs(Rot + DeslocamentoLinear / CurveRaioVert * Math.sin(Rot) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Teta + DeslocamentoLinear / CurveRaioVert * Math.sin(Rot)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(Phi + DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi + DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi))) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(x + DeslocamentoLinear * Math.cos(DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi)) * Math.cos(DeslocamentoLinear / CurveRaioVert * Math.sin(Rot))) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(y - DeslocamentoLinear * Math.cos(DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi)) * Math.sin(DeslocamentoLinear / CurveRaioVert * Math.sin(Rot))) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(z - DeslocamentoLinear * Math.cos(DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi))) >= AntonioVandre.MaximoValorReal))) {Teta += DeslocamentoLinear / CurveRaioVert * Math.sin(Rot); Phi += DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi + DeslocamentoLinear / CurveRaioVert * Math.cos(Rot) * Math.cos(Phi)); Rot += DeslocamentoLinear / CurveRaioVert * Math.sin(Rot) * Math.sin(Phi); x += DeslocamentoLinear * Math.cos(Phi) * Math.cos(Teta); y -= DeslocamentoLinear * Math.cos(Phi) * Math.sin(Teta); z -= DeslocamentoLinear * Math.sin(Phi); ContadorFrames = 0;} else VariavelLimiteAtingido();} else {Phi -= Math.signum(Phi) * DeslocamentoAngular; ContadorFrames = FramesDeslocamento; Phit = Phi; FlagPhiSuperior = 1;}} else {Teta -= Math.signum(Teta) * DeslocamentoAngular; ContadorFrames = FramesDeslocamento; Tetat = Teta; FlagTetaInferior = 1;}
									}
								}
							else
								{
								if (ke.isShiftDown())
									...
									if ((Math.abs(x + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) - Math.cos(Phi + Math.PI / 2) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.sin(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.cos(Phi) + (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.sin(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) * (Math.sin(Teta) < Math.cos(Teta) && Math.sin(Phi) >= 0 ? -1 : 1)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - Math.sin(Phi + Math.PI / 2) * Math.cos(Rot)) >= AntonioVandre.MaximoValorReal))
										VariavelLimiteAtingido();
									else
										{
										x += (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.cos(Rot) - Math.cos(Phi + Math.PI / 2) * Math.cos(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) * Math.sin(Phi);
										y -= (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.cos(Rot) + Math.cos(Phi) * Math.sin(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.cos(Phi) + (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.sin(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) * (Math.sin(Teta) < Math.cos(Teta) && Math.sin(Phi) >= 0 ? -1 : 1);
										z -= Math.sin(Phi + Math.PI / 2) * Math.cos(Rot);
										}
									}
								else
									{
									if ((Math.abs(x + DeslocamentoLinearStatic * Math.cos(Phi) * Math.cos(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - DeslocamentoLinearStatic * Math.cos(Phi) * Math.sin(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - DeslocamentoLinearStatic * Math.sin(Phit)) >= AntonioVandre.MaximoValorReal))
										VariavelLimiteAtingido();
									else
										{
										x += DeslocamentoLinearStatic * Math.cos(Phi) * Math.cos(Teta);
										y -= DeslocamentoLinearStatic * Math.cos(Phi) * Math.sin(Teta);
										z -= DeslocamentoLinearStatic * Math.sin(Phi);
										}
									}
								}
						...
						case KeyEvent.VK_LEFT:
							if (ke.isControlDown())
								...
								if ((Math.abs(x - (Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) - (Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) - Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) * Math.sin(Phi)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - (Math.cos(Phi) * Math.sin(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.sin(Rot)) * Math.cos(Phi) - (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi) * Math.sin(Teta + Math.PI / 2) * Math.sin(Rot)) * Math.sin(Phi) + (Math.cos(Phi + Math.PI / 2) * Math.sin(Teta + Math.PI / 2) * Math.cos(Rot) - Math.cos(Phi + Math.PI / 2) * Math.sin(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Teta) * Math.sin(Phi))) >= AntonioVandre.MaximoValorReal) || (Math.abs(z + Math.sin(Phi + Math.PI / 2) * Math.sin(Rot)) >= AntonioVandre.MaximoValorReal))
									VariavelLimiteAtingido();
								else
									{
									x -= (Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Phi)) - (Math.cos(Phi) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) + Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) + (Math.cos(Phi + Math.PI / 2) * Math.cos(Teta + Math.PI / 2) * Math.cos(Rot) - Math.cos(Phi + Math.PI / 2) * Math.cos(Teta) * Math.sin(Rot)) * Math.abs(Math.sin(Teta)) * Math.sin(Phi);
						...
						case KeyEvent.VK_NUMPAD5:
							...
							if (ke.isControlDown())
								...
								if (ke.isShiftDown())
									{
									if ((Math.abs(x + DeslocamentoLinearStatic * Math.cos(Phi) * Math.cos(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(y - DeslocamentoLinearStatic * Math.cos(Phi) * Math.sin(Teta)) >= AntonioVandre.MaximoValorReal) || (Math.abs(z - DeslocamentoLinearStatic * Math.sin(Phit)) >= AntonioVandre.MaximoValorReal) || (Math.abs(Rot + StraightRotSpeed * DeslocamentoAngular) >= AntonioVandre.MaximoValorReal))
										VariavelLimiteAtingido();
									else
										{
										x += DeslocamentoLinearStatic * Math.cos(Phi) * Math.cos(Teta);
						...
						case KeyEvent.VK_NUMPAD7:
							if (ke.isShiftDown())
								{
								FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 1; FlagCoordRotRotVert = 0; CameraId = -1;

								if (! (Math.abs(RotacaoRotHor - DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) RotacaoRotHor -= DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

								if ((! (Math.abs(TetaRotHor - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotHor)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(PhiRotHor - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotHor) * Math.cos(PhiRotHor)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(RotRotHor - DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotHor) * Math.sin(PhiRotHor)) >= AntonioVandre.MaximoValorReal))) {TetaRotHor -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotHor); PhiRotHor += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotHor) * Math.cos(PhiRotHor); RotRotHor -= DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotHor) * Math.sin(PhiRotHor); x = xRotacaoRotHor - RaioRotHor * Math.cos(PhiRotHor + Math.PI) * Math.cos(TetaRotHor); y = yRotacaoRotHor + RaioRotHor * Math.cos(PhiRotHor + Math.PI) * Math.sin(TetaRotHor); z = zRotacaoRotHor + RaioRotHor * Math.sin(PhiRotHor + Math.PI); ContadorFrames = 0;} else VariavelLimiteAtingido();
								}
							else
								{
								FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 1; FlagCoordRotRotVert = 0; CameraId = -1;
						...
						case KeyEvent.VK_NUMPAD8:
							if (ke.isShiftDown())
								{
								FlagCoordRot = 0; FlagCoordRotHor = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotHor = 0; FlagCoordRotRotVert = 1; CameraId = -1;

								if (! (Math.abs(RotacaoRotVert - DeslocamentoAngular * VelocidadeRotacaoAutomatica) >= AntonioVandre.MaximoValorReal)) RotacaoRotVert -= DeslocamentoAngular * VelocidadeRotacaoAutomatica; else VariavelLimiteAtingido();

								if ((! (Math.abs(TetaRotVert + DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotVert)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(PhiRotVert + DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotVert) * Math.cos(PhiRotVert)) >= AntonioVandre.MaximoValorReal)) || (! (Math.abs(RotRotVert + DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotVert) * Math.sin(PhiRotVert)) >= AntonioVandre.MaximoValorReal))) {TetaRotVert += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotVert); PhiRotVert += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.cos(RotRotVert) * Math.cos(PhiRotVert); RotRotVert += DeslocamentoAngular * VelocidadeRotacaoAutomatica * Math.sin(RotRotVert) * Math.sin(PhiRotVert); x = xRotacaoRotVert - RaioRotVert * Math.cos(PhiRotVert + Math.PI) * Math.cos(TetaRotVert); y = yRotacaoRotVert + RaioRotVert * Math.cos(PhiRotVert + Math.PI) * Math.sin(TetaRotVert); z = zRotacaoRotVert + RaioRotVert * Math.sin(PhiRotVert + Math.PI); ContadorFrames = 0;} else VariavelLimiteAtingido();
								}
							else
								{
								FlagCoordRot = 0; FlagCoordRotVert = 0; FlagCoordRotVert = 0; FlagCoordRotCirc = 0; FlagCoordRotRotVert = 0; FlagCoordRotRotVert = 1; CameraId = -1;
		...
		while(Sair == 0)
			...
			if ((MouseDown == 0) || (! ((FlagRotTetaPos == 0) && (FlagRotTetaNeg == 0) && (FlagRotPhiPos == 0) && (FlagRotPhiNeg == 0) && (FlagRotRotTetaPos == 0) && (FlagRotRotTetaNeg == 0) && (FlagRotRotPhiPos == 0) && (FlagRotRotPhiNeg == 0) && (FlagRotCircPos == 0) && (FlagRotCircNeg == 0))))
				{
				if (ContadorFrames < FramesDeslocamento)
					{
					if (xt != x)
			...
			if (FlagCoordRotRotHor == 0)
				{
				xRotacaoRotHor = x + RaioRotHor * Math.cos(Teta) * Math.cos(Phi);
				yRotacaoRotHor = y - RaioRotHor * Math.sin(Teta) * Math.cos(Phi);
				zRotacaoRotHor = z - RaioRotHor * Math.sin(Phi);
				RotacaoRotHor = 0;
				PhiRotHor = Phi;
				RotRotHor = Rot;
				TetaRotHor = Teta;
			...
			if (FlagCoordRotRotVert == 0)
				{
				xRotacaoRotVert = x + RaioRotVert * Math.cos(Teta) * Math.cos(Phi);
				yRotacaoRotVert = y - RaioRotVert * Math.sin(Teta) * Math.cos(Phi);
				zRotacaoRotVert = z - RaioRotVert * Math.sin(Phi);
				RotacaoRotVert = 0;
				PhiRotVert = Phi;
				RotRotVert = Rot;
				TetaRotVert = Teta;
				FlagCoordRotRotVert = 1;
				}
				...
				if ((Math.abs(Teta) - DeslocamentoAngular > AntonioVandre.MaximoValorReal - DeslocamentoAngular) || (Math.abs(Phi) - DeslocamentoAngular > AntonioVandre.MaximoValorReal - DeslocamentoAngular) || (Math.abs(Rot) - DeslocamentoAngular > AntonioVandre.MaximoValorReal - DeslocamentoAngular))
					...
					if (Math.abs(Teta) < TetaMax - DeslocamentoAngular)
						...
						if (Math.abs(Phi) < PhiMax - DeslocamentoAngular)
							{
							Teta += MouseSensi * (2 * Math.PI * 10 * DeslocamentoAngular * (MouseX - MouseXR) * Math.cos(Rot) + Math.PI * 10 * DeslocamentoAngular * (MouseY - MouseYR) * Math.sin(Rot)) * (Math.cos(Phi) >= 0 ? 1 : -1) / TamanhoPlanoX;

							Phi += MouseSensi * (-2 * Math.PI * 10 * DeslocamentoAngular * (MouseX - MouseXR) * Math.sin(Rot) + Math.PI * 10 * DeslocamentoAngular * (MouseY - MouseYR) * Math.cos(Rot)) * Math.cos(Phi + MouseSensi * (-2 * Math.PI * 10 * DeslocamentoAngular * (MouseX - MouseXR) * Math.sin(Rot) + Math.PI * 10 * DeslocamentoAngular * (MouseY - MouseYR) * Math.cos(Rot)) * Math.cos(Phi) * (Math.cos(Phi) >= 0 ? 1 : -1) / TamanhoPlanoY) * (Math.cos(Phi) >= 0 ? 1 : -1) / TamanhoPlanoY;

							Rot += MouseSensi * (2 * Math.PI * 10 * DeslocamentoAngular * (MouseX - MouseXR) * (Math.cos(Phi) >= 0 ? 1 : -1) * Math.cos(Rot) / TamanhoPlanoX + Math.PI * 10 * DeslocamentoAngular * (MouseY - MouseYR) * Math.sin(Rot) * (Math.cos(Phi) >= 0 ? 1 : -1) / TamanhoPlanoY) * Math.sin(Phi);
			...
			if (Remainder2PI == 1)
				...
				Phit = Phit % (2 * Math.PI);
				Rott = Rott % (2 * Math.PI);
				TetaRotHor = TetaRotHor % (2 * Math.PI);
				PhiRotHor = PhiRotHor % (2 * Math.PI);
				RotRotHor = RotRotHor % (2 * Math.PI);
				TetaRotVert = TetaRotVert % (2 * Math.PI);
				PhiRotVert = PhiRotVert % (2 * Math.PI);
				RotRotVert = RotRotVert % (2 * Math.PI);
				}
			...
			if (FlagAlteracaoStatus == 1)
				...
				RotacaoRotVert = RotacaoRotVertBak;
				...
				if (ContadorFrames == FramesDeslocamento)
					{
					if (FlagRotTetaPos == 1)
						{RotTetaPos(); FlagAlteracaoStatus = 1;}

					if (FlagRotTetaNeg == 1)
						{RotTetaNeg(); FlagAlteracaoStatus = 1;}

					if (FlagRotPhiPos == 1)
						{RotPhiPos(); FlagAlteracaoStatus = 1;}

					if (FlagRotPhiNeg == 1)
						{RotPhiNeg(); FlagAlteracaoStatus = 1;}

					if (FlagRotRotTetaPos == 1)
						{RotRotTetaPos(); FlagAlteracaoStatus = 1;}

					if (FlagRotRotTetaNeg == 1)
						{RotRotTetaNeg(); FlagAlteracaoStatus = 1;}

					if (FlagRotRotPhiPos == 1)
						{RotRotPhiPos(); FlagAlteracaoStatus = 1;}

					if (FlagRotRotPhiNeg == 1)
						{RotRotPhiNeg(); FlagAlteracaoStatus = 1;}

					if (FlagRotCircPos == 1)
						{RotCircPos(); FlagAlteracaoStatus = 1;}
				...
				StringValorHex = StringUtils.numberToHexString(CorValorR) + StringUtils.numberToHexString(CorValorG) + StringUtils.numberToHexString(CorValorB);

				TextoLabel = "<html><p style=\"line-height: 50%;\">x = <font color=\"#" + StringValorHex + "\">" + String.valueOf(x) + "</font>. y = <font color=\"#" + StringValorHex + "\">" + String.valueOf(-y) + "</font>. z = <font color=\"#" + StringValorHex + "\">" + String.valueOf(-z) + "</font>.<br><br>θ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Teta) + "</font>. Max θ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(TetaMax) + "</font>.<br>φ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Phi) + "</font>. Max φ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(PhiMax) + "</font>.<br><br>Rot = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Rot) + "</font>.<br><br>Raio θ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioTeta) + "</font>. Rotacao θ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RotacaoTeta) + "</font>.<br>Raio φ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioPhi) + "</font>. Rotacao φ = <font color=\"#" + StringValorHex + "\">" + String.valueOf(-RotacaoPhi) + "</font>.<br>Raio de rotação = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioRot) + "</font>. Rotacao = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Rotacao) + "</font>.<br> RaioPRotCirc = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioPRotCirc) + "</font>. RaioSRotCirc = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioSRotCirc) + "</font>.<br> Rotação automática = <font color=\"#" + StringValorHex + "\">" + String.valueOf((! ((FlagRotTetaPos == 0) && (FlagRotTetaNeg == 0) && (FlagRotPhiPos == 0) && (FlagRotPhiNeg == 0) && (FlagRotRotTetaPos == 0) && (FlagRotRotTetaNeg == 0) && (FlagRotRotPhiPos == 0) && (FlagRotRotPhiNeg == 0) && (FlagRotCircPos == 0) && (FlagRotCircNeg == 0))) ? 1 : 0) + "</font>. VelocidadeRotacaoAutomatica = <font color=\"#" + StringValorHex + "\">" + String.valueOf(VelocidadeRotacaoAutomatica) + "</font>.<br>CurveRaioHor = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CurveRaioHor) + "</font>. CurveRaioVert = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CurveRaioVert) + "</font>.<br>RotacaoCirc = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RotacaoCirc) + "</font>. StraightRotSpeed = <font color=\"#" + StringValorHex + "\">" + String.valueOf(StraightRotSpeed) + "</font>.<br>RaioRotHor = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioRotHor) + "</font>. RaioRotVert = <font color=\"#" + StringValorHex + "\">" + String.valueOf(RaioRotVert) + "</font>.<br><br>Distância da tela = <font color=\"#" + StringValorHex + "\">" + String.valueOf(DistanciaTela) + "</font>.<br>Ângulo de visão = <font color=\"#" + StringValorHex + "\">" + String.valueOf(AnguloVisao + MargemAnguloVisao) + "</font>.<br>Aspect ratio = <font color=\"#" + StringValorHex + "\">" + String.valueOf(AspectRatio) + "</font><br><br>P0 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro0) + "</font>. P0S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro0Step) + "</font>. P1 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro1) + "</font>. P1S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro1Step) + "</font>.<br>P2 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro2) + "</font>. P2S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro2Step) + "</font>. P3 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro3) + "</font>. P3S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro3Step) + "</font>.<br>P4 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro4) + "</font>. P4S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro4Step) + "</font>. P5 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro5) + "</font>. P5S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro5Step) + "</font>.<br>P6 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro6) + "</font>. P6S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro6Step) + "</font>. P7 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro7) + "</font>. P7S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro7Step) + "</font>.<br>P8 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro8) + "</font>. P8S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro8Step) + "</font>. P9 = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro9) + "</font>. P9S = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Parametro9Step) + "</font>.<br><br>CameraMovePar = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CameraMovePar) + "</font>. CameraMoveParStep = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CameraMoveParStep) + "</font>.<br><br>Stretch = <font color=\"#" + StringValorHex + "\">" + String.valueOf(StretchFlag) + "</font>. Apfloat = <font color=\"#" + StringValorHex + "\">" + String.valueOf(ApfloatFlag) + "</font>. fillPolygon = <font color=\"#" + StringValorHex + "\">" + String.valueOf(TrianguloPoligono) + "</font>. ResolucaoTriangulos = <font color=\"#" + StringValorHex + "\">" + String.valueOf(ResolucaoTriangulos) + "</font>. SleepTime = <font color=\"#" + StringValorHex + "\">" + String.valueOf(SleepTime) + "</font>.<br> FlagTime = <font color=\"#" + StringValorHex + "\">" + String.valueOf(FlagTime) + "</font>. CamId = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CameraId) + "</font>. CameraView = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CameraView) + "</font>. CameraViewFollow = <font color=\"#" + StringValorHex + "\">" + String.valueOf(CameraViewFollow) + "</font>. Remainder2PI = <font color=\"#" + StringValorHex + "\">" + String.valueOf(Remainder2PI) + "</font><br>MouseSensi = <font color=\"#" + StringValorHex + "\">" + String.valueOf(MouseSensi) + "</font>. NoMouse = <font color=\"#" + StringValorHex + "\">" + String.valueOf(NoMouse) + "</font>.<br><br>TrickSpeed = <font color=\"#" + StringValorHex + "\">" + String.valueOf(TrickSpeed) + "</font>. TrickRot = <font color=\"#" + StringValorHex + "\">" + String.valueOf(TrickRot) + "</font>. TricksFactor = <font color=\"#" + StringValorHex + "\">" + String.valueOf(TricksFactor) + "</font>.<br><br>Aperte F1 para ajuda.</p></html>";
					...
					try
						...
						(new Thread () {
							public void run ()
								...
								if (FrameEspaco.getY() < 0)
									FrameRendering.setLocation(FrameEspaco.getX(), FrameEspaco.getY() + FrameEspaco.getHeight() + 2);
								else
									{
									if (FrameEspaco.getX() + FrameEspaco.getWidth() + 2 + TamanhoRenderingX + 2 * RadiusRenderingCircle + 4 > screenSize.getWidth())
										FrameRendering.setLocation(FrameEspaco.getX() - (TamanhoRenderingX + 2 * RadiusRenderingCircle + 4) - 2, FrameEspaco.getY());
									else
										FrameRendering.setLocation(FrameEspaco.getX() + FrameEspaco.getWidth() + 2, FrameEspaco.getY());
									}

								FrameRendering.setVisible(true);

								int ContadorRenderingStep = 0;

								int RenderingStep = (int) ((TotalRenderingL + TotalRenderingT - 2) / RenderingCircleSteps);
								...
								do
									...
									if (ContadorRendering % RenderingStep == 0)
										{
										CompRendering.addTriangulosRenderingShape(RadiusRenderingCircle + 2, (int) ((TamanhoRenderingY - FrameRendering.getInsets().top) / 2), (int) (RadiusRenderingCircle + 2 + RadiusRenderingCircle * Math.cos(2 * Math.PI * ContadorRenderingStep / (TotalRenderingL + TotalRenderingT - 2))), (int) ((int) ((TamanhoRenderingY - FrameRendering.getInsets().top) / 2) - RadiusRenderingCircle * Math.sin(2 * Math.PI * ContadorRenderingStep / (TotalRenderingL + TotalRenderingT - 2))), (int) (RadiusRenderingCircle + 2 + RadiusRenderingCircle * Math.cos(2 * Math.PI * ContadorRendering / (TotalRenderingL + TotalRenderingT - 2))), (int) ((int) ((TamanhoRenderingY - FrameRendering.getInsets().top) / 2) - RadiusRenderingCircle * Math.sin(2 * Math.PI * ContadorRendering / (TotalRenderingL + TotalRenderingT - 2))));

										try {Thread.sleep(1);} catch(InterruptedException e) {}

										ContadorRenderingStep = ContadorRendering;
										}

									} while (ContadorRendering < TotalRenderingL + TotalRenderingT - 2);

								CompRendering.TriangulosRenderingShape.clear();
	...
	public void DesenharEspaco(AV3DNavigator Comp)
		...
		if (CameraView == 1)
			...
			if (CameraViewFollow == 1)
				...
				Phi = ((x - xCamera == 0) && (-y - yCamera == 0)) ? ((-z - zCamera >= 0) ? Math.PI / 2 : -Math.PI / 2) : (((x - xCamera)*(x - xCamera) + (-y - yCamera)*(-y - yCamera) + (-z - zCamera)*(-z - zCamera) == 0) ? 0 : Math.asin((-z - zCamera) / Math.sqrt((x - xCamera)*(x - xCamera) + (-y - yCamera)*(-y - yCamera) + (-z - zCamera)*(-z - zCamera))));
		...
		labelLinhas: for (i = 0; i < TEspaco; i++)
			...
			if (! (EspacoLinhas[i].equals("")))
				...
				if (ApfloatFlag == 0)
					...
					if ((FlagMxparser == 1) || (CoordenadasDest[0].contains("AV3DNP0")) || (CoordenadasDest[0].contains("AV3DNP1")) || (CoordenadasDest[0].contains("AV3DNP2")) || (CoordenadasDest[0].contains("AV3DNP3")) || (CoordenadasDest[0].contains("AV3DNP4")) || (CoordenadasDest[0].contains("AV3DNP5")) || (CoordenadasDest[0].contains("AV3DNP6")) || (CoordenadasDest[0].contains("AV3DNP7")) || (CoordenadasDest[0].contains("AV3DNP8")) || (CoordenadasDest[0].contains("AV3DNP9")) || (CoordenadasDest[0].contains("AV3DNPF0")) || (CoordenadasDest[0].contains("AV3DNPF1")) || (CoordenadasDest[0].contains("AV3DNPF2")) || (CoordenadasDest[0].contains("AV3DNPF3")) || (CoordenadasDest[0].contains("AV3DNPF4")) || (CoordenadasDest[0].contains("AV3DNF5")) || (CoordenadasDest[0].contains("AV3DNPF6")) || (CoordenadasDest[0].contains("AV3DNPF7")) || (CoordenadasDest[0].contains("AV3DNPF8")) || (CoordenadasDest[0].contains("AV3DNPF9")) || (CoordenadasDest[0].contains("AV3DNPTS")) || (CoordenadasDest[0].contains("AV3DNPTM")) || (CoordenadasDest[0].contains("AV3DNPTH")))
						{
					...
					if ((FlagMxparser == 1) || (CoordenadasDest[1].contains("AV3DNP0")) || (CoordenadasDest[1].contains("AV3DNP1")) || (CoordenadasDest[1].contains("AV3DNP2")) || (CoordenadasDest[1].contains("AV3DNP3")) || (CoordenadasDest[1].contains("AV3DNP4")) || (CoordenadasDest[1].contains("AV3DNP5")) || (CoordenadasDest[1].contains("AV3DNP6")) || (CoordenadasDest[1].contains("AV3DNP7")) || (CoordenadasDest[1].contains("AV3DNP8")) || (CoordenadasDest[1].contains("AV3DNP9")) || (CoordenadasDest[1].contains("AV3DNPF0")) || (CoordenadasDest[1].contains("AV3DNPF1")) || (CoordenadasDest[1].contains("AV3DNPF2")) || (CoordenadasDest[1].contains("AV3DNPF3")) || (CoordenadasDest[1].contains("AV3DNPF4")) || (CoordenadasDest[1].contains("AV3DNF5")) || (CoordenadasDest[1].contains("AV3DNPF6")) || (CoordenadasDest[1].contains("AV3DNPF7")) || (CoordenadasDest[1].contains("AV3DNPF8")) || (CoordenadasDest[1].contains("AV3DNPF9")) || (CoordenadasDest[1].contains("AV3DNPTS")) || (CoordenadasDest[1].contains("AV3DNPTM")) || (CoordenadasDest[1].contains("AV3DNPTH")))
						{
					...
					if ((FlagMxparser == 1) || (CoordenadasDest[2].contains("AV3DNP0")) || (CoordenadasDest[2].contains("AV3DNP1")) || (CoordenadasDest[2].contains("AV3DNP2")) || (CoordenadasDest[2].contains("AV3DNP3")) || (CoordenadasDest[2].contains("AV3DNP4")) || (CoordenadasDest[2].contains("AV3DNP5")) || (CoordenadasDest[2].contains("AV3DNP6")) || (CoordenadasDest[2].contains("AV3DNP7")) || (CoordenadasDest[2].contains("AV3DNP8")) || (CoordenadasDest[2].contains("AV3DNP9")) || (CoordenadasDest[2].contains("AV3DNPF0")) || (CoordenadasDest[2].contains("AV3DNPF1")) || (CoordenadasDest[2].contains("AV3DNPF2")) || (CoordenadasDest[2].contains("AV3DNPF3")) || (CoordenadasDest[2].contains("AV3DNPF4")) || (CoordenadasDest[2].contains("AV3DNF5")) || (CoordenadasDest[2].contains("AV3DNPF6")) || (CoordenadasDest[2].contains("AV3DNPF7")) || (CoordenadasDest[2].contains("AV3DNPF8")) || (CoordenadasDest[2].contains("AV3DNPF9")) || (CoordenadasDest[2].contains("AV3DNPTS")) || (CoordenadasDest[2].contains("AV3DNPTM")) || (CoordenadasDest[2].contains("AV3DNPTH")))
						{
					...
					yi = (int) (TamanhoPlanoYAd / 2 + TamanhoPlanoYAd / 2 * DistanciaTela * (Math.sin(Rott) * (xo * Math.sin(Tetat) + yo * Math.cos(Tetat)) / (Math.sqrt(xo * xo + yo * yo + zo * zo)) + Math.cos(Rott) * (xo * Math.cos(Tetat) * Math.sin(Phit) - yo * Math.sin(Tetat) * Math.sin(Phit) + zo * Math.cos(Phit)) / (Math.sqrt(xo * xo + yo * yo + zo * zo)))) - CorrecaoY;
					...
					yf = (int) (TamanhoPlanoYAd / 2 + TamanhoPlanoYAd / 2 * DistanciaTela * (Math.sin(Rott) * (xd * Math.sin(Tetat) + yd * Math.cos(Tetat)) / (Math.sqrt(xd * xd + yd * yd + zd * zd)) + Math.cos(Rott) * (xd * Math.cos(Tetat) * Math.sin(Phit) - yd * Math.sin(Tetat) * Math.sin(Phit) + zd * Math.cos(Phit)) / (Math.sqrt(xd * xd + yd * yd + zd * zd)))) - CorrecaoY;
					...
					if ((Math.acos(ProdutoEscalaro / Math.sqrt(xo * xo + yo * yo + zo * zo)) < AnguloVisao + MargemAnguloVisao) && ((Math.acos(ProdutoEscalard / Math.sqrt(xd * xd + yd * yd + zd * zd)) < AnguloVisao + MargemAnguloVisao)))
						{
						...
						if (Campos.length == 1)
							...
							for (j = 0; j < 3; j++)
								if ((FlagMxparser == 1) || (RGB[j].contains("AV3DNP0")) || (RGB[j].contains("AV3DNP1")) || (RGB[j].contains("AV3DNP2")) || (RGB[j].contains("AV3DNP3")) || (RGB[j].contains("AV3DNP4")) || (RGB[j].contains("AV3DNP5")) || (RGB[j].contains("AV3DNP6")) || (RGB[j].contains("AV3DNP7")) || (RGB[j].contains("AV3DNP8")) || (RGB[j].contains("AV3DNP9")) || (RGB[j].contains("AV3DNPF0")) || (RGB[j].contains("AV3DNPF1")) || (RGB[j].contains("AV3DNPF2")) || (RGB[j].contains("AV3DNPF3")) || (RGB[j].contains("AV3DNPF4")) || (RGB[j].contains("AV3DNF5")) || (RGB[j].contains("AV3DNPF6")) || (RGB[j].contains("AV3DNPF7")) || (RGB[j].contains("AV3DNPF8")) || (RGB[j].contains("AV3DNPF9")) || (RGB[j].contains("AV3DNPTS")) || (RGB[j].contains("AV3DNPTM")) || (RGB[j].contains("AV3DNPTH")))
									{
			...
			if (! (EspacoTriangulosShapePreenchidos[i].equals("")))
				...
				for (j = 0; j < Pontoslength; j++)
					...
					if (ApfloatFlag == 0)
						...
						if ((FlagMxparser == 1) || (Coordenadas[0].contains("AV3DNP0")) || (Coordenadas[0].contains("AV3DNP1")) || (Coordenadas[0].contains("AV3DNP2")) || (Coordenadas[0].contains("AV3DNP3")) || (Coordenadas[0].contains("AV3DNP4")) || (Coordenadas[0].contains("AV3DNP5")) || (Coordenadas[0].contains("AV3DNP6")) || (Coordenadas[0].contains("AV3DNP7")) || (Coordenadas[0].contains("AV3DNP8")) || (Coordenadas[0].contains("AV3DNP9")) || (Coordenadas[0].contains("AV3DNPF0")) || (Coordenadas[0].contains("AV3DNPF1")) || (Coordenadas[0].contains("AV3DNPF2")) || (Coordenadas[0].contains("AV3DNPF3")) || (Coordenadas[0].contains("AV3DNPF4")) || (Coordenadas[0].contains("AV3DNF5")) || (Coordenadas[0].contains("AV3DNPF6")) || (Coordenadas[0].contains("AV3DNPF7")) || (Coordenadas[0].contains("AV3DNPF8")) || (Coordenadas[0].contains("AV3DNPF9")) || (Coordenadas[0].contains("AV3DNPTS")) || (Coordenadas[0].contains("AV3DNPTM")) || (Coordenadas[0].contains("AV3DNPTH")))
							{
						...
						if ((FlagMxparser == 1) || (Coordenadas[1].contains("AV3DNP0")) || (Coordenadas[1].contains("AV3DNP1")) || (Coordenadas[1].contains("AV3DNP2")) || (Coordenadas[1].contains("AV3DNP3")) || (Coordenadas[1].contains("AV3DNP4")) || (Coordenadas[1].contains("AV3DNP5")) || (Coordenadas[1].contains("AV3DNP6")) || (Coordenadas[1].contains("AV3DNP7")) || (Coordenadas[1].contains("AV3DNP8")) || (Coordenadas[1].contains("AV3DNP9")) || (Coordenadas[1].contains("AV3DNPF0")) || (Coordenadas[1].contains("AV3DNPF1")) || (Coordenadas[1].contains("AV3DNPF2")) || (Coordenadas[1].contains("AV3DNPF3")) || (Coordenadas[1].contains("AV3DNPF4")) || (Coordenadas[1].contains("AV3DNF5")) || (Coordenadas[1].contains("AV3DNPF6")) || (Coordenadas[1].contains("AV3DNPF7")) || (Coordenadas[1].contains("AV3DNPF8")) || (Coordenadas[1].contains("AV3DNPF9")) || (Coordenadas[1].contains("AV3DNPTS")) || (Coordenadas[1].contains("AV3DNPTM")) || (Coordenadas[1].contains("AV3DNPTH")))
							{
						...
						if ((FlagMxparser == 1) || (Coordenadas[2].contains("AV3DNP0")) || (Coordenadas[2].contains("AV3DNP1")) || (Coordenadas[2].contains("AV3DNP2")) || (Coordenadas[2].contains("AV3DNP3")) || (Coordenadas[2].contains("AV3DNP4")) || (Coordenadas[2].contains("AV3DNP5")) || (Coordenadas[2].contains("AV3DNP6")) || (Coordenadas[2].contains("AV3DNP7")) || (Coordenadas[2].contains("AV3DNP8")) || (Coordenadas[2].contains("AV3DNP9")) || (Coordenadas[2].contains("AV3DNPF0")) || (Coordenadas[2].contains("AV3DNPF1")) || (Coordenadas[2].contains("AV3DNPF2")) || (Coordenadas[2].contains("AV3DNPF3")) || (Coordenadas[2].contains("AV3DNPF4")) || (Coordenadas[2].contains("AV3DNF5")) || (Coordenadas[2].contains("AV3DNPF6")) || (Coordenadas[2].contains("AV3DNPF7")) || (Coordenadas[2].contains("AV3DNPF8")) || (Coordenadas[2].contains("AV3DNPF9")) || (Coordenadas[2].contains("AV3DNPTS")) || (Coordenadas[2].contains("AV3DNPTM")) || (Coordenadas[2].contains("AV3DNPTH")))
							{
						...
						ypp = (int) (TamanhoPlanoYAd / 2 + TamanhoPlanoYAd / 2 * DistanciaTela * (Math.sin(Rott) * (xp * Math.sin(Tetat) + yp * Math.cos(Tetat)) / (Math.sqrt(xp * xp + yp * yp + zp * zp)) + Math.cos(Rott) * (xp * Math.cos(Tetat) * Math.sin(Phit) - yp * Math.sin(Tetat) * Math.sin(Phit) + zp * Math.cos(Phit)) / (Math.sqrt(xp * xp + yp * yp + zp * zp)))) - CorrecaoY;

						ProdutoEscalar = xp * Math.cos(Tetat) * Math.cos(Phit) - yp * Math.sin(Tetat) * Math.cos(Phit) - zp * Math.sin(Phit);

						if ((Math.acos(ProdutoEscalar / Math.sqrt(xp * xp + yp * yp + zp * zp)) < AnguloVisao + MargemAnguloVisao))
							{
							ContadorPontos++;

								if ((FlagMxparser == 1) || (EspacoP.contains("AV3DNP0")) || (EspacoP.contains("AV3DNP1")) || (EspacoP.contains("AV3DNP2")) || (EspacoP.contains("AV3DNP3")) || (EspacoP.contains("AV3DNP4")) || (EspacoP.contains("AV3DNP5")) || (EspacoP.contains("AV3DNP6")) || (EspacoP.contains("AV3DNP7")) || (EspacoP.contains("AV3DNP8")) || (EspacoP.contains("AV3DNP9")) || (EspacoP.contains("AV3DNPF0")) || (EspacoP.contains("AV3DNPF1")) || (EspacoP.contains("AV3DNPF2")) || (EspacoP.contains("AV3DNPF3")) || (EspacoP.contains("AV3DNPF4")) || (EspacoP.contains("AV3DNF5")) || (EspacoP.contains("AV3DNPF6")) || (EspacoP.contains("AV3DNPF7")) || (EspacoP.contains("AV3DNPF8")) || (EspacoP.contains("AV3DNPF9")) || (EspacoP.contains("AV3DNPTS")) || (EspacoP.contains("AV3DNPTM")) || (EspacoP.contains("AV3DNPTH")))
						...
						try
							{
							if (ApfloatMath.acos(ProdutoEscalara.divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(ApfloatMath.sin(new Apfloat(Tetat, PrecisaoApfloat))).multiply(zpa))))).doubleValue() < AnguloVisao + MargemAnguloVisao)
								{
								ContadorPontos++;
					...
					if (! (EspacoLinhas[i].equals("")))
						...
						for (j = 0; j < Pontoslength; j++)
							...
							for (k = 0; k < Coordenadas.length; k++)
								if (((! (AntonioVandre.NumeroReal(Coordenadas[k]))) && (FlagMxparser == 0)) && (! Coordenadas[k].contains("AV3DNP0")) && (! Coordenadas[k].contains("AV3DNP1")) && (! Coordenadas[k].contains("AV3DNP2")) && (! Coordenadas[k].contains("AV3DNP3")) && (! Coordenadas[k].contains("AV3DNP4")) && (! Coordenadas[k].contains("AV3DNP5")) && (! Coordenadas[k].contains("AV3DNP6")) && (! Coordenadas[k].contains("AV3DNP7")) && (! Coordenadas[k].contains("AV3DNP8")) && (! Coordenadas[k].contains("AV3DNP9")) && (! Coordenadas[k].contains("AV3DNPF0")) && (! Coordenadas[k].contains("AV3DNPF1")) && (! Coordenadas[k].contains("AV3DNPF2")) && (! Coordenadas[k].contains("AV3DNPF3")) && (! Coordenadas[k].contains("AV3DNPF4")) && (! Coordenadas[k].contains("AV3DNPF5")) && (! Coordenadas[k].contains("AV3DNPF6")) && (! Coordenadas[k].contains("AV3DNPF7")) && (! Coordenadas[k].contains("AV3DNPF8")) && (! Coordenadas[k].contains("AV3DNPF9")) && (! Coordenadas[k].contains("AV3DNPTS")) && (! Coordenadas[k].contains("AV3DNPTM")) && (! Coordenadas[k].contains("AV3DNPTH"))) return "Erro";
							}
						...
						if (Campos.length == 2)
							...
							if (! (Campos[1].equals("")))
								...
								for (k = 0; k < RGB.length; k++)
									{
									if ((FlagMxparser == 1) || (RGB[k].contains("AV3DNP0")) || (RGB[k].contains("AV3DNP1")) || (RGB[k].contains("AV3DNP2")) || (RGB[k].contains("AV3DNP3")) || (RGB[k].contains("AV3DNP4")) || (RGB[k].contains("AV3DNP5")) || (RGB[k].contains("AV3DNP6")) || (RGB[k].contains("AV3DNP7")) || (RGB[k].contains("AV3DNP8")) || (RGB[k].contains("AV3DNP9")) || (RGB[k].contains("AV3DNPF0")) || (RGB[k].contains("AV3DNPF1")) || (RGB[k].contains("AV3DNPF2")) || (RGB[k].contains("AV3DNPF3")) || (RGB[k].contains("AV3DNPF4")) || (RGB[k].contains("AV3DNF5")) || (RGB[k].contains("AV3DNPF6")) || (RGB[k].contains("AV3DNPF7")) || (RGB[k].contains("AV3DNPF8")) || (RGB[k].contains("AV3DNPF9")) || (RGB[k].contains("AV3DNPTS")) || (RGB[k].contains("AV3DNPTM")) || (RGB[k].contains("AV3DNPTH")))
										{
					...
					if (! (EspacoTriangulosShapePreenchidos[i].equals("")))
						...
						if (Campos.length == 2)
							...
							if (! (Campos[1].equals("")))
								...
								for (k = 0; k < RGB.length; k++)
									{
									if (((! (AntonioVandre.NumeroReal(RGB[k]))) && (FlagMxparser == 0)) && (! RGB[k].contains("AV3DNP0")) && (! RGB[k].contains("AV3DNP1")) && (! RGB[k].contains("AV3DNP2")) && (! RGB[k].contains("AV3DNP3")) && (! RGB[k].contains("AV3DNP4")) && (! RGB[k].contains("AV3DNP5")) && (! RGB[k].contains("AV3DNP6")) && (! RGB[k].contains("AV3DNP7")) && (! RGB[k].contains("AV3DNP8")) && (! RGB[k].contains("AV3DNP9"))) return "Erro";

									if ((FlagMxparser == 0) && (! RGB[k].contains("AV3DNP0")) && (! RGB[k].contains("AV3DNP1")) && (! RGB[k].contains("AV3DNP2")) && (! RGB[k].contains("AV3DNP3")) && (! RGB[k].contains("AV3DNP4")) && (! RGB[k].contains("AV3DNP5")) && (! RGB[k].contains("AV3DNP6")) && (! RGB[k].contains("AV3DNP7")) && (! RGB[k].contains("AV3DNP8")) && (! RGB[k].contains("AV3DNP9"))) if ((Integer.parseInt(RGB[k]) < 0) || (Integer.parseInt(RGB[k]) > 255))
										return "Erro";
									}
								}
							}
